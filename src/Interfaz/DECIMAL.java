...
public class DECIMAL extends JFrame {
	...
	public DECIMAL() {
		...
		JLabel lblNewLabel = new JLabel("DECIMAL A BINARIO");
		...
		JLabel lblNewLabel_1 = new JLabel("INGRESE EL NUMERO DECIMAL");
